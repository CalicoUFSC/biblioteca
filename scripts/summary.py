...
[![Build Status]\
(https://travis-ci.org/CalicoUFSC/biblioteca.svg?branch=master)]\
(https://travis-ci.org/CalicoUFSC/biblioteca)

Deseja contribuir? Leia nosso [Guia de Contribuição]\
(https://github.com/CalicoUFSC/biblioteca/blob/master/CONTRIBUTING.md).
